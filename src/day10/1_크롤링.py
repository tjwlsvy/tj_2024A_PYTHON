...
'''
    ...
    [3] 파싱 메소드 , 속성
        1. .find( 식별자  , 속성명 = 값 ) : 지정한 식별자 와 속성명 동일한 태그 조회
            find(div)
        ...
        -
            ...
            .string : 마크업 사이의 문자열 , 자식만 가능 , 자손 불가능 , 주로 단일텍스트 일때
...
# .attrs : 지정한 마크업의 속성 목룍을 딕셔너리 반환
print(soup.findAll('a')[0].attrs) # {'href': 'http://wwww.hanbit.co.kr/member/login.html', 'class': ['login']}
print(soup.findAll('a')[0]['href']) # <li><a class="login" href="http://wwww.hanbit.co.kr/member/login.html">로그인</a>
